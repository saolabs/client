...
import type { FragmentInterface, HtmlInterface, SaoChildrenFactory, SaoElementChildren } from "../contracts/ElementInterface.js";
 ...
 */
export declare class Fragment implements FragmentInterface {
    ...
    initMode: InitMode;
    domChildren: Node[];
    constructor({ ctx, id, initMode, parentElement, childrenFactory }: {
