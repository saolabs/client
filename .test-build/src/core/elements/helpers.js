...
exports.getSaoObjectType = getSaoObjectType;
exports.parseElementChildren = parseElementChildren;
function getSaoObjectType(instance) {
    if (instance && typeof instance === 'object' && 'saoType' in instance) {
        return instance.saoType;
    }
    return null;
}
function parseElementChildren(oneElement, parentElement, children) {
