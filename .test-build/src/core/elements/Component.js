...
class Component {
    constructor({ ctx, parent = null, id = null, stateKeys = [], data = {}, dataFactory = null, path = null, type = 'default', condition = null, initMode = common_1.InitModes.CREATE, }) {
        ...
        this.initMode = common_1.InitModes.CREATE; // Default initialization mode
        this.subscribeFn = () => { };
        this.unsubscribeFn = () => { };
        ...
        this.id = `${ctx.viewId}-${id ?? (0, utils_1.generateUUID)(10)}`; // Unique ID for debugging
        this.dataFactory = dataFactory;
        this.path = path;
        this.type = type;
        this.condition = condition;
        this.initMode = initMode ?? common_1.InitModes.CREATE;
    }
    mergeData(newData) {
    ...
    mountChild() {
        ...
        if (wrapper && typeof wrapper === 'object' && 'openTag' in wrapper) {
            ...
            (0, view_1.mountChildrenBeforeAnchor)(wrapper.closeTag, wrapper.render(), this.parent);
        }
